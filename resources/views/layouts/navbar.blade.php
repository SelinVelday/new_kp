        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item me-2 me-xl-0">
                <a class="nav-link style-switcher-toggle hide-arrow" href="javascript:void(0);" onclick="window.toggleTheme(event)">
                    @if(Auth::user()->theme == 'dark') <i class='bx bx-sun bx-sm'></i> @else <i class='bx bx-moon bx-sm'></i> @endif
                </a>
            </li>
                ...
                <ul class="dropdown-menu dropdown-menu-end py-0">
                    <li class="dropdown-menu-header border-bottom">
                        <div class="dropdown-header d-flex align-items-center py-3">
                            ...
                            <a href="javascript:void(0)" onclick="markAllRead()" class="dropdown-notifications-all text-body" title="Tandai semua dibaca"><i class="bx bx-envelope-open fs-4"></i></a>
                        </div>
                    </li>
                                ...
                                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            {{-- KHUSUS UNDANGAN: TAMPILKAN TOMBOL TERIMA / TOLAK --}}
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <form action="{{ route('logout') }}" method="POST">@csrf <button type="submit" class="dropdown-item"><i class="bx bx-power-off me-2"></i> Log Out</button></form>
                    </li>
                </ul>
            </li>
        </ul>
